...
![](/assets/images/tsp_pic/real.png){:width="40%" height="40%"}
...
![](/assets/images/tsp_pic/tanh.png){:width="40%" height="40%"}

These are the simulated results using Mean field theory.
![](/assets/images/tsp_pic/MF.png){:width="40%" height="40%"}
...
![](/assets/images/tsp_pic/1dchain.png){:width="20%" height="20%"}
...
![](/assets/images/tsp_pic/2dlattice.png){:width="25%" height="25%"}
...
![](/assets/images/tsp_pic/transition.png){:width="60%" height="60%"}

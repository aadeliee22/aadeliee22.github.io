...
![](/assests/images/tsp_pic/I_1.png)
![](/assets/images/tsp_pic/real.png){:width="10% height="10%}
...
![](/assets/images/tsp_pic/tanh.png){:width="10% height="10%}

These are the simulated results using Mean field theory.
![](/assets/images/tsp_pic/MF.png){:width="10% height="10%}
...
![](/assets/images/tsp_pic/1dchain.png){:width="42% height="42%}
...
$$
Let's consider $\bar{h}=0$ for a moment. , then $ is the energy gap between groundstate and first excited state. Then the thermal partition function is
$$
...
![](/assets/images/tsp_pic/2dlattice.png){:width="45% height="45%}
...
$$
![](/assets/images/tsp_pic/2dspacing.png){:width="45% height="45%}
...
![](/assets/images/tsp_pic/transition.png){:width="55% height="55%}

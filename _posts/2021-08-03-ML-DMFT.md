...
$$
\mathrm{Im}\Delta(i\omega_n) = \frac{1}{4}\mathrm{Im}G(i\omega_n) = \mathrm{Im}\left[\frac{1}{4}\int_{-\infty}^\infty\frac{A(\omega')\ud \omega'}{i\omega_n-\omega'}\right]
= -\mathrm{Im}\left[\frac{1}{\pi}\int_{-\infty}^\infty\frac{\mathrm{Im}\Delta(\omega')\ud \omega'}{i\omega_n-\omega'}\right] \\
\mathbf{W}_j^{(1)}(i\omega_n) = -\mathrm{Im}\left[\frac{1}{\pi}\int_{-\infty}^\infty\frac{\mathbf{W}_j^{(1)}(\omega')\ud \omega'}{i\omega_n-\omega'}\right]
$$
...
<center><img src="/assets/images/DMFTNN/NN_output_u0.001_100.png" width="75%" height="75%"></center>
<center><img src="/assets/images/DMFTNN/NN_outputcubic_u0.001_100.png" width="25%" height="25%"></center>

#### Neural network, $N_h=10$

<center><img src="/assets/images/DMFTNN/NN_output_u0.001_10.png" width="75%" height="75%"></center>
<center><img src="/assets/images/DMFTNN/NN_outputcubic_u0.001_10.png" width="25%" height="25%"></center>

#### Logistic regression

<center><img src="/assets/images/DMFTNN/LogisticRegression_output_u0.01.png" width="75%" height="75%"></center>
<center><img src="/assets/images/DMFTNN/LogisticRegression_outputcubic_u0.01.png" width="25%" height="25%"></center>

...
3. Testing step: the input layer receives the imaginary part of the hybrdization function on the Matsubara frequency domain. 

<center><img src="/assets/images/DMFTNN/flow.png" width="75%" height="75%"></center>
